...
public final class DarkMode {
    ...
    public static void setDarkEnabled(Context ctx, boolean enabled) {
        preference(ctx).edit().putBoolean(KEY_DARK, enabled).apply();
    ...
    public static boolean isDarkEnabled(Context ctx) {
        return preference(ctx).getBoolean(KEY_DARK, false);
    }
    ...
    private static SharedPreferences preference(Context ctx) {
